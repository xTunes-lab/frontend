the music player
<div class="flex text-3xl font-bold underline px-8 justify-center">
    <div class="w-96 shadow-lg rounded-b-xl">
        <div
        ...
        >
            <div class="flex items-center space-x-4">
                ...
                <div class="min-w-0 flex-auto space-y-1 font-semibold">
                    <p
                        class="text-cyan-500 dark:text-cyan-400 text-sm leading-6"
                    >
